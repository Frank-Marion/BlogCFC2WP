...
<!--- 2013-11-17 FM: Update the category count field (why are they storing this derived value in the db anyways??)--->
<cfinvoke component="Wordpress" method="InsertWPCategoriesIntoRelationshipTable" returnvariable="None"/>
